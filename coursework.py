...
class Counter:
    ...
    def add(self, word: str, repetition: int = 1):
        """Increases the stored count for a word by the repetition count.

        Args:
            word: The word to add to the counter.
            repetition: The number of times to add the word. Defaults to 1.
        ...
        self.words[word] = self.words.get(word, 0) + repetition
